...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        hidden_layer_error = np.multiply((self.hidden_to_output_weights.transpose() * output_layer_error),np.vectorize(rectified_linear_unit_derivative)(hidden_layer_weighted_input))  # TODO (3 by 1 matrix)

        bias_gradients = hidden_layer_error  # TODO
        hidden_to_output_weight_gradients = np.multiply(output_layer_error, hidden_layer_activation).transpose()  # TODO
        input_to_hidden_weight_gradients = hidden_layer_error @ (input_values.transpose())  # TODO
